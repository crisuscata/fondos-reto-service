...
@Embeddable
public class CostoTratamientoHabitosMalosId implements Serializable {

    @Column(name = "tipo_cancer")
    private String tipoCancer;

    public CostoTratamientoHabitosMalosId() {}

    public CostoTratamientoHabitosMalosId(String tipoCancer) {
    ...
    public boolean equals(Object o) {
        ...
        CostoTratamientoHabitosMalosId that = (CostoTratamientoHabitosMalosId) o;
